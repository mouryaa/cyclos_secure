...
<cyclos:script src="/pages/groups/customizedFiles/editGroupCustomizedFile.js" />
<ssl:form method="post" action="${formAction}" >
<html:hidden property="file(id)" />
<html:hidden property="file(group)" />

<table class="defaultTableContent" cellspacing="0" cellpadding="0">
    <tr>
        <td class="tdHeaderTable"><bean:message key="group.customizedFiles.title.${isInsert ? 'new' : 'modify'}" arg0="${group.name}"/></td>
        <c:set var="help" value="${isMember ? 'operators#customize_group_file' : 'groups#customize_group_file'}"/>
